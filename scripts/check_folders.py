...
Examples:
    ...
    parser.add_argument('--folders', '-f', nargs='+', help='List of folders to test (space-separated)')
    parser.add_argument('--list-all', '-l', action='store_true', help='List all available folders before testing')
...
def main():
    ...
    if args.folders:
        ...
        test_folders = [config.INBOX, config.SPAM_LEARN, config.HAM_LEARN, config.SPAM_FOLDER, config.HAM_FOLDER]
